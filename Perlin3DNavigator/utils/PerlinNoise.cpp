...
#define	PERLINNOISE_LOG(log)	((void)0);



#define	rand		my_rand
#define	srand(seed)	my_srand(seed)


PerlinNoise::PerlinNoise()
  : _seed(0)
{
  Set(/*octaves*/ 1, /*freq*/ 2, /*amp*/ 1, /*seed*/ 0);
  _start = false;
...
void	PerlinNoise::Set(int octaves, float freq, float amplitude, int seed)
{
  _octaves = octaves;
  _frequency = freq;
...
float PerlinNoise::noise2(float vec[2])
{
  ...
  // t = vec[1] + N;		PERLINNOISE_LOG("t = " << t);
  // by0 = ((int)t) & BM;		PERLINNOISE_LOG("by0 = " << by0);
  // by1 = (by0 + 1) & BM;		PERLINNOISE_LOG("by1 = " << by1);
  // ry0 = t - (int)t;		PERLINNOISE_LOG("ry0 = " << ry0);
  // ry1 = ry0 - 1.0f;		PERLINNOISE_LOG("ry1 = " << ry1);
